...
Esta atualização traz seleção geométrica através da malha, operações por gesto, ajuste da última operação, borda interna e extrusão pela normal, barras compactas e desenho de componentes em GPU. O [relatório da 0.2.1](docs/v0.2.1.md) registra os marcos, testes, capturas e comparação com a referência preservada da 0.2.0. Nenhuma tag, Release ou push faz parte desta entrega.
