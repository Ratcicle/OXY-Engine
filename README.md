...
A **0.3.3.1** permite alinhar o Corpo de movimento por deslocamento local X/Y/Z, com campos e gizmo, sem mover a origem ou aparência. RMB + **E/C** sobe/desce no eixo global Y. Consulte [testes e limites do patch](docs/v0.3.3.1.md).
