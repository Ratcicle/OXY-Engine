param([Parameter(Mandatory)][string]$Label, [string]$Sizes = '100,200,400,800,1600', [string]$Executable = '', [ValidateSet('performance','performance_extra','performance_mesh','performance_movement','performance_bodies')][string]$Example = 'performance', [string]$ReferenceCommit = '')
