...
if ($manifest.schema_version -notin @(1,2,3,4) -or $manifest.scenes.Count -lt 3) { throw 'As cenas de exemplo devem estar presentes em formato suportado (schema 1, 2, 3 ou 4).' }
