...
Esta atualização acrescenta personagem cinemático 3D, primeira/terceira pessoa, superfícies, plataformas em translação, perfis de movimento e nós tipados. O [relatório da 0.3.0](docs/v0.3.0.md) distingue implementação, testes, medições e limites da validação. Modelagem, pintura, histórico e fluxo portátil da 0.2.1 permanecem. Nenhuma tag, Release ou push faz parte desta entrega.
